...
const String CACHE_FAILURE_MESSAGE = 'Cache exception.';
const String OFFLINE_FAILURE_MESSAGE = 'Please check your Internet connection.';
const String WEAK_PASS_FAILURE_MESSAGE = "Please use a stronger password.";
...
const String SIGN_UP_SUCCESS_MESSAGE = "Signed up successfully.";
const String VALIDATION_ERROR_MESSAGE =
