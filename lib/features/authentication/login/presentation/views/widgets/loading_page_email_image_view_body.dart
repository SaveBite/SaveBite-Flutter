...
class LoadingPageEmailImageViewBody extends StatefulWidget {
  const LoadingPageEmailImageViewBody({super.key});

  @override
  _LoadingPageEmailImageViewBodyState createState() =>
      _LoadingPageEmailImageViewBodyState();
}

class _LoadingPageEmailImageViewBodyState
    extends State<LoadingPageEmailImageViewBody>
