...
class LoginEmailImageButtomBlocBuilder extends StatelessWidget {
  const LoginEmailImageButtomBlocBuilder({
    super.key,
    required this.myKey,
  });
    ...
    return BlocConsumer<LoginCubit, LoginState>(
      listener: (context, state) {
        if (state is LoginSuccess) {
          ...
          GoRouter.of(context)
              .pushReplacement(AppRouter.kLoadingPageEmailImageView);
        }
      },
          ...
          return CustomActiveButtom(
            ...
            onTap: () async {
              if (myKey.currentState!.validate()) {
                await BlocProvider.of<LoginCubit>(context).loginEmailiImage();
              }
            },
          );
        } else {
