...
import 'package:save_bite/features/authentication/login/presentation/views/widgets/login_email__password_form.dart';

class LoginEmailPsswordViewBody extends StatelessWidget {
  const LoginEmailPsswordViewBody({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              CustomButton(
                onTap: () {
                   GoRouter.of(context)
                      .pushReplacement(AppRouter.kLoginEmailImageView);
                },
                content: Text(
                  'Login with image',
