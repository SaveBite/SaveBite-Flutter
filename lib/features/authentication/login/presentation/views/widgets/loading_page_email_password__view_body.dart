...
class LoadingPageEmailPasswordViewBody extends StatefulWidget {
  ...
  @override
  _LoadingPageEmailPasswordViewBodyState createState() => _LoadingPageEmailPasswordViewBodyState();
}

class _LoadingPageEmailPasswordViewBodyState extends State<LoadingPageEmailPasswordViewBody>
    ...
    return BlocListener<LoginCubit, LoginState>(
      listener: (context, state) {
        if (state is LoginFailure) {
          ...
          GoRouter.of(context).pushReplacement(AppRouter.kLoginEmailPasswordView);
