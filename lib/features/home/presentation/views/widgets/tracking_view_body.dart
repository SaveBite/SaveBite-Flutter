...
class TrackingViewBody extends StatelessWidget {
  ...
  final List<TrackingProduct> _sampleProducts = [
    TrackingProduct(
      ...
      endDate: '2025-12-01',
      imageUrl:
          '/data/user/0/com.example.save_bite/cache/4ac80497-5950-4ea9-813f-7da801eb5cdf/img_00013.jpg',
    ),
  ];
              ...
              onTap: () {
                ...
                if (_sampleProducts.isNotEmpty) {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => AddEditProductPage(
                        initialProduct: _sampleProducts[
                            0], // Set to null to avoid pre-filling
